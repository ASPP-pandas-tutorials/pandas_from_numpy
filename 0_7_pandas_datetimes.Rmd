...
This is where having a specialized representation of time comes in handy. We can use the `pd.to_datetime()` function to convert this data to Pandas' special representation of a particular point in time. 
