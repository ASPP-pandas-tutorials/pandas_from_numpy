...
Even better, let's manually specificy the `name` attribute - to make it clearer down the line what the `True` and `False` values mean e.g. whether each country has a higher-than-median HDI score:
