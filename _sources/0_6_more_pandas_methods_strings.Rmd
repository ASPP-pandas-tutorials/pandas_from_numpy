...
> 📝 NOTE: Covered here:
>
> * string operations, ex: df[‘name’].str[2:4], df[‘name’].str.count('a') [For this, compare different country names between Mat > Mort data and Dev/Fertility data, e.g. different names for Russia and South Korea])
> 
> * Strings (and dates) have a special accessor to perform vectorized
> string (or date) operations
> 
> * specialized accessor methods Series.str
> 
> **Matthew Notes: do everything on a Series first. Series.str follow the pandas from numpy structure**
> 
...
> 
> * show str methods with a dataframe + how this can be very useful when cleaning data
...
Because each Data Frame column is nothing other than a Pandas Series, we can use string methods in the same way as we saw in the last secton:
