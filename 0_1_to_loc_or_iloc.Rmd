...
Along the way, we'll often press not to use direct indexing on Series, as there is still some dangerous ambiguity in which type of indexing you are doing with direct indexing on Series.
...
a non-integer index) with direct indexing.  But recently, the Pandas
developers have reconsidered, and are planning to remove this ambiguous use of
integer indexing, on the basis that it is too easy to be confused as to which
type of indexing you are doing.
